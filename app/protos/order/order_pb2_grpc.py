...
import protos.order.order_pb2 as order__pb2
...
def add_OrderServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'protos.order.OrderService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('protos.order.OrderService', rpc_method_handlers)
